...
class OrderBookTestSuite(unittest.TestCase):
    ...
    def ignore_test_orderbook(self):
        asks = [(1., 1.), (2., 3.)]
        bids = [(3., 1.)]
        orderbook = tkgtri.OrderBook('S', asks, bids)
    ...
    def test_depth(self):
        ...
        self.assertIsNone(orderbook.get_depth(10, "sell"))
    ...
    def test_order_book_depth_for_destination_currency(self):
        ...
        self.assertEqual(orderbook.get_depth_for_destination_currency(0.3, "ETH"),
                         tkgtri.Depth(total_quantity=3.1131883637, total_price=0.0963642302, depth=2, currency="base"))
